...
import { APIGuild, ChannelType } from "discord-api-types/v10";
...
interface FlattenedGuildChannel extends FlattenedChannel {
  ...
  permissionOverwrites?: [
    string,
    { id: string; type: string; deny: number; allow: number },
  ][];
...
interface PartialOauthFlattenedGuild extends Omit<
  FlattenedGuild,
  "joinedTimestamp" | "ownerId" | "region" | "features"
> {
