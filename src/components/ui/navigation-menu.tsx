  ...
  return (
    ...
    >
      <NavigationMenuPrimitive.Viewport
        ...
        className={cn(
          "origin-top-center bg-white text-zinc-950 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden rounded-md border border-zinc-200 shadow md:w-[var(--radix-navigation-menu-viewport-width)] dark:bg-zinc-950 dark:text-zinc-50 dark:border-zinc-800",
          className
        )}
        {...props}
      />
...
function NavigationMenuIndicator({
  ...
  return (
    <NavigationMenuPrimitive.Indicator
      ...
      {...props}
    >
      <div className="bg-zinc-200 relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm shadow-md dark:bg-zinc-800" />
    </NavigationMenuPrimitive.Indicator>
  )
}
