...
export default function Wallet() {
  const fetchWalletLeaderboard = async ({
    ...
    const data = await apiFetch<WalletLeaderboard[]>(
      `/leaderboard?id=wallet&offset=${pageParam * 10}&limit=${10}`,
    );
    return data;
  };
  const {
    ...
    queryKey: ["leaderboard", "wallet"],
    queryFn: fetchWalletLeaderboard,
    initialPageParam: 0,
